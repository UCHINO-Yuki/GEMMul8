#pragma once
#include "../../include/herkx.hpp"
#include "../oz2/common/common.hpp"
#include "../oz2/herkx/herkx_launch.hpp"
...
std::vector<double> herkx(
    ...
    static_assert(common::isComplex<TA>, "herkx requires complex input type.");

    cudaStream_t stream;
    cublasGetStream(handle, &stream);

    if (num_moduli > 1) {
        return oz2::herkx::herkx_launch<TA, TB, TC, BACKEND>(
