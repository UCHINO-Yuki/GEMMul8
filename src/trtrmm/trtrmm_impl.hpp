#pragma once
#include "../../include/trtrmm.hpp"
#include "../oz2/common/common.hpp"
#include "../oz2/trtrmm/trtrmm_launch.hpp"
...
std::vector<double> trtrmm(
    ...
    if (num_moduli > 1) {
        return oz2::trtrmm::trtrmm_launch<TA, TB, TC, BACKEND>(
            common::Handle_t(common::CublasTag{}, handle),
            uplo_A, uplo_B, trans_A, trans_B, diag_A, diag_B, n,
