...
#include "../test/common/self_hipify.hpp"
#include <iostream>
...
int main(int argc, char **argv) {
    ...
    std::vector<double> hC_exact = {
        0x1.d51136ef01e9dp+1, 0x1.5b07528da2db2p+2, -0x1.b7d034d197c42p-4, 0x1.59b0e0e988db5p+1,
