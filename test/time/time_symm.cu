        ...
        for (auto &k : K_list) {
            ...
            if (run_oz2_i8) {
                for (unsigned num_moduli = num_moduli_min; num_moduli <= num_moduli_max; ++num_moduli) {
                    ...
                    const size_t lwork_gemmul8_i8 = gemmul8::workSize<testTraits<T>::is_complex, gemmul8::Backend::INT8, func>(m, n, k, num_moduli);
            ...
            if (run_oz2_f8) {
                for (unsigned num_moduli = num_moduli_min; num_moduli <= num_moduli_max; ++num_moduli) {
                    ...
                    const size_t lwork_gemmul8_f8 = gemmul8::workSize<testTraits<T>::is_complex, gemmul8::Backend::FP8, func>(m, n, k, num_moduli);
...
template void check_time<float>(std::string &, std::string &, cublasFillMode_t, cublasSideMode_t, const bool, const bool, const bool, const bool);
template void check_time<double>(std::string &, std::string &, cublasFillMode_t, cublasSideMode_t, const bool, const bool, const bool, const bool);
template void check_time<cuFloatComplex>(std::string &, std::string &, cublasFillMode_t, cublasSideMode_t, const bool, const bool, const bool, const bool);
template void check_time<cuDoubleComplex>(std::string &, std::string &, cublasFillMode_t, cublasSideMode_t, const bool, const bool, const bool, const bool);
